module.exports = (app) => {
    ...
    const nlpLeaves = require("../../controller/Auth/apply.leave.nlp.controller.js")
    ...
    router.post("/apply-leave", asyncHandler(nlpLeaves.getDateAndReason))
    ...
    app.use("/api/routes/apply-leave-nlp", router);
  };